...
class BoardTest {
    ...
    void testMultipleConsecutiveClicks() {
        ...
        boolean result1 = deterministicBoard.revealCell(0, 1);
        ...
        assertTrue(
            deterministicBoard.getCell(0, 1).isRevealed() ||
            deterministicBoard.getCell(4, 4).isRevealed() ||
            deterministicBoard.getCell(6, 6).isRevealed(),
