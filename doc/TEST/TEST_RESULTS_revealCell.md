...
|   TC_15_02   |  UC-15   | Flood fill should stop at numbered cells                       | Click (0,0) on board with no mines                    | All 25 cells revealed (5x5 board, no mines)            | ✅ PASS  |
|   TC_17_01   |  UC-17   | Out of bounds negative coordinates should be ignored           | `revealCell(-1, -1)` and variations                   | All return true, no cells modified                     | ✅ PASS  |
|   TC_17_02   |  UC-17   | Out of bounds coordinates beyond max should be ignored         | `revealCell(100, 100)`, `revealCell(ROWS, COLS)`      | All return true without error                          | ✅ PASS  |
...
| UC-15 – Flood Fill        | Blank cell detection, flood fill operation, boundary termination  |      2      |
| UC-17 – Bounds/Edge Cases | Out of bounds handling, coordinate validation                     |      2      |
| **TOTAL**                 |                                                                   | **14/14 ✅** |